...
\vspace{0.5cm}
	...
	\lstinputlisting[language=R, firstline=40, lastline=57]{PS1.R} 
	

\begin{lstlisting}[language=R]
	ks_statistic      p_value 
	1.320026e-01 1.494601e-05 
 \end{lstlisting}
...
\vspace{.5cm}
\lstinputlisting[language=R, firstline=65,lastline=67]{PS1.R} 

	\lstinputlisting[language=R, firstline=64, lastline=83]{PS1.R} 
\begin{lstlisting}[language=R]
[1] 0.1398324 2.7265559
\end{lstlisting}

\lstinputlisting[language=R, firstline=51,lastline=53]{PS1.R} 

\lstinputlisting[language=R, firstline=85, lastline=87]{PS1.R} 
\begin{lstlisting}[language=R]
